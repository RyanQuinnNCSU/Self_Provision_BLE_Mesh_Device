...
#define LCD_ROW_SENSOR_DATA  5    /**< 5th row, first row of data read by client */
#define LCD_ROW_PEOPLE_COUNT 5    /**< 5th row, people count value */
#define LCD_ROW_TEMPERATURE  6    /**< 6th row, color temperature / sensor temperature */
